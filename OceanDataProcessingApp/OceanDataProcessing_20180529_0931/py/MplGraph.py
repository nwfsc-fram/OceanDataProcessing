...
class MplGraph(QObject):
    ...
    def __init__(self, qml_item=None, graph_name=None, df=None,
        ...
        self.figure = self.qml_item.getFigure()              # Matplotlib Figure
        ...
        # self.axis.xaxis.set_minor_locator(ticker.MultipleLocator(5))
        # self.axis.yaxis.set_minor_locator(ticker.MultipleLocator(5))
        # self.axis.tick_params(axis='x', which='minor')
        # self.axis.grid(b=True, which='minor')
        # ax.yaxis.grid(True)
        # ax.xaxis.grid(True)

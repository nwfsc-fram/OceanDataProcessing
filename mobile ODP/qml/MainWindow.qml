...
//                enabled: settings.loggedInStatus
            ...
            ToolButton {
                ...
                tooltip: "Settings"
                onClicked: {
                    settingsDialog.dataPath = settings.dataPath;
                    settingsDialog.isDeployed = settings.isDeployed;
                    settingsDialog.swDeployedSoftware.checked = settings.isDeployed;
                    settingsDialog.open();
                }
            } // btnSettings
            ...
            ComboBox {
                ...
                enabled: settings.isDeployed ? false : true
                model: settings.surveyModel
                currentIndex: 0
                onCurrentIndexChanged: {
                    settings.survey = currentText;
                    if (currentText != "") {
...
//                    var values;
//                    if ((cbSurvey.currentText) && (cbVessel.currentText)) {
//                        values = {"survey": cbSurvey.currentText,
...
//                                  "instrument": currentText}
//                    }
//                    if ((cbVessel.currentText !== "Select Vessel") || (settings.isDeployed)) {
//                        settings.changeVesselInstrument(values);
//                    }
                }
            } // cbInstrument
